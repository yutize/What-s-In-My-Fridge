   ...
   <Navbar />
    ...
    <main>
      <div className="flex-1 flex flex-col items-center gap-8 min-h-0">
        <div className="max-w-[1000px] w-full space-y-6 px-4 pt-[30px] pb-[40px]">
          <div className="rounded-3xl border border-gray-200 p-8 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 pb-[10px]">Welcome back, !</h1>
